...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
                  ...
                  children: [
                    Container(
                      ...
                      child: PageView(
                        ...
                        children: [
                          buildImage('assets/images/home.webp'),
                          buildImage('assets/images/image2.webp'),
                          buildImage('assets/images/image3.webp'),
                          buildImage('assets/images/image4.webp'),
                          buildImage('assets/images/image5.webp'),
                        ],
                      ),
                    ),
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => NavigationsScreen(initialIndex: 0), // Change 1 to the correct index for Mobility Aids
      ),
    );
  },
                  child:
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => NavigationsScreen(initialIndex: 1), // Change 1 to the correct index for Mobility Aids
      ),
    );
  },
                  child:
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => NavigationsScreen(initialIndex: 2), // Change 1 to the correct index for Mobility Aids
      ),
    );
  },
      child:
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                constraints: BoxConstraints(maxWidth: 79),
                                child: Text(
                                  'Diagnostic \nequipment',
                                  style: TextStyle(
                                    fontFamily: 'Inter',
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => NavigationsScreen(initialIndex: 3), // Change 1 to the correct index for Mobility Aids
      ),
    );
  },
                  child:
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => NavigationsScreen(initialIndex: 4), // Change 1 to the correct index for Mobility Aids
      ),
    );
  },
                  child:
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                constraints: BoxConstraints(maxWidth: 83),
                                child: Text(
                                  'Medical \nequipment',
                                  style: TextStyle(
                                    fontFamily: 'Inter',
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                         GestureDetector(
                 onTap: () {
        // Add navigation logic for the first container
        // For example, Navigator.push(context, MaterialPageRoute(builder: (context) => YourNewPage()));
                            },
                  child:
                        Container(
