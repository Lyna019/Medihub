...
class diag extends StatelessWidget {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (result.price == 0.0) {
                        ...
                        priceText = '\$${result.price.toStringAsFixed(2)}';
                      }
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.network(
                                  result.imageUrl,
                                  width:
                                      150.0, // Set width to match container width
                                  height: 135.0,
                                  fit: BoxFit
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildResultSection(context, 'Paid', 'Diagnostic Equipment',
                rentCollection.snapshots()),
            _buildResultSection(context, 'Donation', 'Diagnostic Equipment',
